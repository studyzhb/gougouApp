...
var Condition = React.createClass({
  ...
  render() {
    ...
    var imageRows = this.state.imageRows.map((r, i) => {
        return <TouchableOpacity key={i} style={styles.imageBox} onPress={(event) => this._changeImage(event, i)}>
        ...
        <View style={styles.form}>
          <View style={styles.content}>
            ...
            <View style={styles.images}>
              ...
              <TouchableOpacity style={styles.addImage} onPress={(event) => this._selectImage(event)}>
